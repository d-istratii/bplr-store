...
function ProductPage({ product }: Product) {
    ...
    const [dropdownClothingSize, setDropdownClothingSize] = useState(true);
    ...
    return (
        <div>
            <div className='grid h-screen grid-cols-2 place-items-center gap-16  bg-gradient-to-b from-neutral-900 to-neutral-800 pt-24 sm:grid-cols-1'>
                <button className='mb-4 justify-self-end rounded-3xl bg-white text-white shadow-2xl duration-200'>
                ...
                <div className='flex flex-col items-center justify-center space-y-2 justify-self-start text-white'>
                    ...
                    {dropdownClothingSize ? (
                        <div>
                            <motion.button
                                className='flex w-64 flex-row justify-between rounded border p-2 shadow-2xl'
                                onClick={() => {
                                    setDropdownClothingSize(
                                        !dropdownClothingSize
                                    );
                                }}
                                transition={{
                            ...
                            >
                                ...
                                <motion.button
                                    ...
                                    animate={{
                                        rotate: dropdownClothingSize ? 0 : 180,
                                    }}
                                    className='ml-1 mt-1 text-white sm:p-4'
                                >
                    ...
                    <div className='flex flex-row space-x-3 pt-4'>
                        <button
                            className='flex flex-row rounded-lg bg-white p-3 shadow-2xl duration-200 hover:scale-105'
                            onClick={() => itemAddition(1)}
                        >
