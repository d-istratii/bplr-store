			...
			<SwiperSlide>
				<div className='z-0 flex h-screen w-full flex-col items-center justify-between space-y-4  bg-tshirt-img bg-cover bg-center p-4 text-lg text-white'>
					...
					<div className='flex flex-col items-center space-y-2'>
						<h1 className='bg-gradient-to-r from-yellow-200 to-amber-600 bg-clip-text text-8xl text-transparent sm:text-5xl'>
							T-SHIRTS
						</h1>
						<h1 className='text-6xl font-extrabold sm:text-3xl '>MADE TO ORDER</h1>
